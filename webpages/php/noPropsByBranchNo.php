<?php
	...
	$sql = "SELECT Employee.branchNo,Rental_Property.rentalNo,Rental_Property.address_street,Rental_Property.address_city,rental_property.address_zip
FROM Employee
INNER JOIN Rental_Property
ON Employee.branchNo = '$branchNo' AND Employee.empId = Rental_Property.empId";
