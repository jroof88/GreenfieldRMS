<?php
	...
	include_once "connect.php";
		...
		echo "<h2> 2) Generate a list of super visors and the properties they supervise </h2>";
		...
		echo "</table>";
		echo "<h2> 4) Show a list of properites available, where the properties shoudl satisfy the criteria (city, noOfRooms, and or/range</h2>";
		...
		echo "<form action='noPropsByBranchNo.php' method='get'>";
		echo "Branch Number: <input type='text' name='branchNo'><br />";
		echo "<input type='submit'>";
		echo "</form>";
